...
=======
        ...
        this.id="i"+String(Math.random()*10000);
>>>>>>> Stashed changes
    }
    setText(text=""){
        this.inner=text;
...
class GUI_Window{
    constructor(children=[],x=25,y=25,flip=false){
            this.children=children;
            if(flip){
                this.innerStart="<div style='position:fixed;float:right;right:"+String(x)+"px;top:"+String(y)+"px;'>";
            }else{
                this.innerStart="<div style='position:fixed;float:left;left:"+String(x)+"px;top:"+String(y)+"px;'>";
            }
            this.innerEnd="</div>";
    }

}
export {GUI,GUI_Text,GUI_Button,GUI_Slider,GUI_Input,GUI_Window};